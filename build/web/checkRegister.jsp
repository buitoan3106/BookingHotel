            ...
            <div class='main'>
                ...
                <div class='main__login'>
                    <div class="check">
                        ...
                        <div class="check__noti">Đăng ký thành công</div>
                        <div>
                            <a href="login.jsp" style="text-decoration: none; color: white"><button class="check__btn btn">Quay lại đăng nhập</button></a>
                        </div>
                    </div>
                </div>
            </div>
